...
for i in range(len(advanced_features) + 1):
    for combo in combinations(advanced_features, i):
        features_list.append(['Close', 'ROC'] + list(combo))
...
for coin in coins:
    for features in features_list:
        ...
        # predict_and_save_with_features(coin, 'usd', 365, features, file_path)
        ...
        transformer_predict(coin, 'usd', 365, features, file_path)
